...
while (y < x) {
    ...
    for ( let z = 0; z < 10; z++ ) {
        ...
        document.getElementById("containerArray").innerHTML += ` <div style="font-weigth: bold; padding: 30px;"> <span style="text-decoration: underline;">Lista n.${y+1}:</span> ${newArray} </div> `;
    console.log( newArray );
    y++
}

// ------------------------------------ CORREZIONE ALTERNATIVA MIA ------------------------------------ //
